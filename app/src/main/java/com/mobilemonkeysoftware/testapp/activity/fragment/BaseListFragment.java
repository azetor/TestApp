...
import com.mobilemonkeysoftware.testapp.model.ui.ListItem;
 ...
 */
public abstract class BaseListFragment<T extends Parcelable & ListItem, AT extends BaseAdapter> extends BaseFragment implements ListView<AT> {
